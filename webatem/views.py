...
@ensure_csrf_cookie                 # the window POSTs with the cookie's token; nothing else sets it
...
@ensure_csrf_cookie                 # 0.5.0 lost the cookie with the connect page's dialog: every POST was a 403
@require_GET
