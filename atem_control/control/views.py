...
@ensure_csrf_cookie   # the page POSTs (media pool, profile, switcher name): nothing else sets the cookie
@access_required
...
# (control/device_api.py). ``equipmentName`` is whatever the host already calls
# this address (``hooks.name_for_ip``; standalone, what mDNS advertises), offered
# as "use <that name>" — the panel never names a host's inventory.
# =============================================================================
