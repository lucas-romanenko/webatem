...
from av_server.atem_control.profile.dialog import (
...
Lives in `av_server/atem_control/static/js/atem_profile.js` (~445
...
The dialog markup lives in `av_server/atem_control/templates/control.html`
...
5. Add a section to `describe_save_sections` in
   `av_server/atem_control/profile/dialog.py` so the AV Server save
...
| Django views | [`../av_server/atem_control/profile/views.py`](../av_server/atem_control/profile/views.py), [`../av_server/atem_control/profile/export.py`](../av_server/atem_control/profile/export.py) |
| Django URLs | [`../av_server/atem_control/urls.py`](../av_server/atem_control/urls.py) |
| Frontend JS | [`../av_server/atem_control/static/js/atem_profile.js`](../av_server/atem_control/static/js/atem_profile.js) |
| Dialog template | [`../av_server/atem_control/templates/control.html`](../av_server/atem_control/templates/control.html) (lines 1814–1970) |
